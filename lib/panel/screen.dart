...
import 'package:miniapp_web/material/material.dart';
...
class Screen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final brickSize = getBrikSizeForScreenWidth(playerPanelWidth);
    
    debugPrint("Screen width: $width");
    debugPrint("Player panel width: $playerPanelWidth");
    debugPrint("Brick size: $brickSize");
